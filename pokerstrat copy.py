...
class Test(Strategy):
        ...
        def decide_play(self, player, pot):
                ...
                if pot.stage == 0:
                        my_score =  self.score(player.total_cards)
        ...
        def score(self,hand):
                ...
                return score
        # This will evaluate the hand when the river is release
